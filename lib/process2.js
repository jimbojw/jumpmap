...
/**
 * Given a Set of systems, compute the center (average x,y,z).
 */
function computeCenter(systems) {
  let x = 0;
  let y = 0;
  let z = 0;
...
function createStationGroups(links) {
  ...
  // For each group, compute the center of the main stations.
  for (const [groupKey, group] of groups) {
    group.center = computeCenter(group.main);
  }
